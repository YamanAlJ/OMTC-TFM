...
set(gca, "FontSize", 12);
set (gca, 'xtick' , [3,9,15,21], 'xticklabel', {"PC3-AR", "LNCaP"})
...
% mlabel5= scatter (100,1,'k^','Parent', Ax(1))
  ...
  % leg1= legend(Ax(1),[mlabel1,mlabel2],'1 kPa', '3 kPa', '12 kPa', '25 kPa', '50 kPa', 'Location', "northeast");set (leg1, "FontSize", 12, "LineWidth", 1.5);
