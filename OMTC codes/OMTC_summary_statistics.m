...
EXPERIMENT = "ET_OMTCTFM_12kPa_SC_PC3CSS_PC31nM_48hour_mOrange_heat_13072022" %USER INPUT 2/3
CONDITION = "PC3_1nMR1881_12kPa_SC" %USER INPUT 3/3
...
for i = 1:length(SPOTS_FILES_ARRAY)
    ...
    x_spots = table2array(spots_table(1:end, 3)); 
    y_spots = table2array(spots_table(1:end, 4)); 
    t_spots = table2array(spots_table(1:end, 2));

    [t_spots, sortIdx] = sort(t_spots, 'ascend');
    x_spots = x_spots(sortIdx);
    y_spots = y_spots(sortIdx);
